 ...
 * entries beneath it, as markdown. Parsed server-side out of CHANGELOG.md (see backend/changelog.ts)
 ...
 * backend/changelog.ts) — the frontend renders these fields and derives nothing from them.
 */
