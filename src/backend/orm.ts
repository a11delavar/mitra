...
import { User, Identity, Integration, CalDAV, GoogleCalendar, Source, Entry, Recurrence, createLogger, logEnabled } from '../shared/index.js'
...
export const orm = await MikroORM.init({
	entities: [User, Identity, Integration, CalDAV, GoogleCalendar, Dev, Source, Entry, Recurrence, NotificationSubscription, Session],
