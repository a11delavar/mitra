...
| Forward one week / month / year | <kbd>→</kbd> |
| Back one week / month / year | <kbd>←</kbd> |
| Go to a specific date | <kbd>G</kbd> |

## Entries

| Action | Keys |
| --- | --- |
| Create an entry | <kbd>C</kbd> |
...
| [Settings](settings.md) | <kbd>Ctrl</kbd> <kbd>,</kbd> |
